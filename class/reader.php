...
//	array_push($data, $muatcetakan4);
	...
	if (is_null($muatcetakan1)){
        $muatcetakan1 = array("jml"=>0,"lbr"=>0,"tg"=>0,"luas"=>0);
	}
	if (is_null($muatcetakan2)){
        $muatcetakan2 = array("jml"=>0,"lbr"=>0,"tg"=>0,"luas"=>0);
	}
	if (is_null($muatcetakan3)){
        $muatcetakan3 = array("jml"=>0,"lbr"=>0,"tg"=>0,"luas"=>0);
	}
	if (is_null($muatcetakan4)){
        $muatcetakan4 = array("jml"=>0,"lbr"=>0,"tg"=>0,"luas"=>0);
	}
		
	//echo json_encode($muatcetakan1) . "_______<br>";	
	$data[]= $muatcetakan1;	
	$data[]= $muatcetakan2;	
	$data[]= $muatcetakan3;	
	$data[]= $muatcetakan4;	
...
//	echo json_encode($data) . "_______<br>";
	return $data;	
...
//	echo "lbrcetak : " . ($lbrcetak * 4) . " - tgcetak :" . ($tgcetak * 4) . " - lebarcetak : " . $lebarcetak . " - panjangcetak : " . $panjangcetak . "<br>";
//	echo json_encode($lipat6) . "<br><br>";
	if ($lipat6[0]['jml'] > 0 && $jilid >= 1 && $set > 16){
		$uk_lbr = $lbrcetak * 4;
		$uk_tg = $tgcetak * 4;
		$lipat = 32;
		$ukuran_lipat1 = array($uk_lbr, $uk_tg);
		$ukuran_lipat2 = array($lbrcetak, $tgcetak);
...
//	echo json_encode($lipat4);
	...
	if (($lipat5[0]['jml'] > 0 || $lipat4[0]['jml'] > 0) && $jilid >= 1 && $set > 8){
		...
		if ($lipat4[0]['jml'] > 0 && $jilid >= 1){
			...
			$uk_tg = $tgcetak * 4;	
			$lipat = 16;
			$ukuran_lipat1 = array($lbrcetak, $tgcetak);
	...
	//echo json_encode($ukuran_lipat) . "_______<br>";	
	return $ukuran_lipat;
