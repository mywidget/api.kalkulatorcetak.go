 ...
 CustomStyle();
		// function cekukuranbu() {
			...
			// xmlhttp.onreadystatechange = function() {
				...
				// }
			// }
			// var url = protocol + '://' + host + '/api/cekukuran/';
