				...
				if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
					...
					data = myArr;
						if ($('#tablbox5').length) {
							...
							$('#tablebox5').append("<div id='detailbox5' class='small'><table id='tablbox5' class='table table-striped pb-0' ><thead ><tr style='background-color:<?= $warnabar; ?>;color:white' ><th  class='text-md-left' style='width:30%'>Mesin</th><th class='text-md-right'>Harga</th></tr></thead></table></div>");
