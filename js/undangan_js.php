...
$("#j_mesin1").filter(function() {
			$('select[data-mesin]').each(function() {
				var $select = $(this);
				$select.append('<option value="0">Pilih mesin isi</option>');
				$.ajax({
...
$("#j_mesinam").filter(function() {
			$('select[data-mesinam]').each(function() {
				var $select = $(this);
				$select.append('<option value="0">Pilih mesin amplop</option>');
				$.ajax({
...
$("#j_mesinkartu").filter(function() {
			$('select[data-mesinkartu]').each(function() {
				var $select = $(this);
				$select.append('<option value="0">Pilih mesin ucapan</option>');
				$.ajax({
...
$("#bahanisiund").filter(function() {
			$('select[data-bahanisi]').each(function() {
				var $select = $(this);
				$select.append('<option value="0">Pilih bahan isi</option>');
				$.ajax({
...
$("#bahancovund").filter(function() {
			$('select[data-bahancover]').each(function() {
				var $select = $(this);
				$select.append('<option value="0">Pilih bahan cover</option>');
				$.ajax({
...
$("#bahanamplopund").filter(function() {
			$('select[data-bahanam]').each(function() {
				var $select = $(this);
				$select.append('<option value="0">Pilih bahan amplop</option>');
				$.ajax({
