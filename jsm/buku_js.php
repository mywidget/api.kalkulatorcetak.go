<?php
	...
	<script type="text/javascript">
		...
		$("#j_mesin1,#j_mesin2,#j_mesin3,#j_mesincov").attr("disabled", true);
		...
		$('#pilih_mesin_2').on('change', function () {
            if (this.value == 0) {
                $("#j_mesin2").attr("disabled", false);
                } else {
                $("#j_mesin2").attr("disabled", true);
			}
		});
		$('#pilih_mesin_3').on('change', function () {
            if (this.value == 0) {
                $("#j_mesin3").attr("disabled", false);
                } else {
                $("#j_mesin3").attr("disabled", true);
			}
		});
		...
		function hitungbu2(r, s) {
			...
			if (jmlwarna != null && jmlwarna < 1) {
				...
				var pilih_mesin = document.getElementById("pilih_mesin_2").value;
				if (pilih_mesin !=0) {
					var idmesin = 0;
					var j_mesin = $('#pilih_mesin_2').val();
					}else{
					var idmesin = $('#j_mesin2').val();
					var j_mesin = $('#j_mesin2').val();
				}
		...
		function hitungbu3(r, s, t, u) {
			...
			if (jmlwarna != null && jmlwarna < 1) {
				...
				var pilih_mesin = document.getElementById("pilih_mesin_3").value;
				if (pilih_mesin !=0) {
					var idmesin = 0;
					var j_mesin = $('#pilih_mesin_3').val();
					}else{
					var idmesin = $('#j_mesin3').val();
					var j_mesin = $('#j_mesin3').val();
				}
		...
		$( "#cekukuran" ).on( "click", function() {
			...
			var pilih_mesin = $("#pilih_mesin").val();
			var pilih_mesin_2 = $("#pilih_mesin_2").val();
			var pilih_mesin_3 = $("#pilih_mesin_3").val();
			var pilih_mesin_4 = $("#pilih_mesin_4").val();
			...
			if (jmlcetak == '') {
				...
				} else if (pilih_mesin == 0) {
				cek_isi_1();
				} else if (pilih_mesin_2 == 0) {
				cek_isi_2();
				} else if (pilih_mesin_3 == 0) {
				cek_isi_3();
				} else if (bahan == 0) {
				salert('warning', 'Oopss...', iMsg['Bi1']);
				} else if (pilih_mesin_4 == 0) {
				cek_cover();
		...
		function cek_isi_1(){
			var j_mesin1 = $("#j_mesin1").val();
			var jmlwarnabu1 = $("#jmlwarnabu1").val();
			var bahanbu1 = $("#bahanbu1").val();
			var jmlhalbu1 = $("#jmlhalbu1").val();
			var pilih_mesin = $("#pilih_mesin").val();
			if (jmlhalbu1 != 0) {
				if (pilih_mesin==0 && j_mesin1 == 0) {
					salert('warning', 'Oopss...', iMsg['Mi1']);
					} else if (jmlwarnabu1 == 0) {
		...
		function cek_cover(){
			// console.log(2);
			var j_mesincov = $("#j_mesincov").val();
			var jmlwarnacovbu = $("#jmlwarnacovbu").val();
			var bahancovbu = $("#bahanbu3").val();
			var jmlhalbu3 = $("#jmlhalbu3").val();
			if (j_mesincov == 0) {
				salert('warning', 'Oopss...', iMsg['MC']);
				} else if (jmlwarnacovbu == 0) {
				salert('warning', 'Oopss...', iMsg['W']);
				} else if (bahancovbu == 0) {
				salert('warning', 'Oopss...', iMsg['Bi3']);
				}else{
