...
<div class="col-md-4" id="ketproduk">
	<div class="row" style="margin-right:5px;margin-left:5px">
		<div class="ket" style="margin:0; padding:5px; line-height: 1.2em;color:#000"><div>Cara Penggunaan :<br><ul><li>Masukan Jumlah Buku yang akan di cetak, kemudian tentukan ukuran lebar dan tinggi buku jadinya. </li><li>Masukan
 isi buku di Box Isi Buku 1, Isi Buku 2 dan Isi Buku 3. Klik tanda panah
 kebawah untuk memilih lebih banyak opsi pada Isi Buku.</li><li>Kemudian tentukan jenis Cover Bukunya</li></ul>Minimal Pembuatan adalah <b>100 buku.</b> <br></div><div><br></div><div>*) Harga perhitungan adalah sebagai perkiraan harga saja, untuk harga sebenarnya harus bertemu langsung, karena kemungkinan berbedanya isi dan bahan Jilid yang dimaksud. </div><br>											<br>											<br></div>
	</div>
</div>
<div class="col-md-8">
			<div class="col-md-7">
 ...
 <select name="ukuranbu" id="ukuranbu" class="custom-select form-control" data-ukuran="http://kalkulator.go/user/api/ukuran/buku" data-valueKey="id" data-displayKey="name" required>	 
</select>
				</div>
				</div> 
<script>
...
$('select[data-ukuran]').each(function() {
 ...
 <select name="bahanbu1" id="bahanbu1" class="custom-select form-control" data-bahanbu1="http://kalkulator.go/user/api/katbahan/buku" data-valueKey="id" data-displayKey="name" required>	 
</select>
				</div>
<script>
      ...
      $select.append($option);
		...
		<div class="col-md-12">
		  <div class="panel panel-default">
			...
			<div class="panel-body isi2" style="padding: 2px; margin:2px">
			<div class="col-md-6">	
			<div class="form-group">
				<div class="input-group">
					<span class="input-group-addon">Jml Warna</span>
      ...
      $select.append($option);
		...
		<div class="col-md-12">
		  <div class="panel panel-default">
			...
			<div class="panel-body isi3" style="padding: 2px; margin:2px">
			<div class="col-md-6">
			<div class="form-group">
				<div class="input-group">
					<span class="input-group-addon">Jml Warna</span>
...
<div class="col-md-12">	
			...
			<div class="input-group">
				<span class="input-group-addon">Mesin Cetak</span>
 <select name="j_mesincov" id="j_mesincov" class="custom-select form-control" data-j_mesincov="http://kalkulator.go/user/api/mesin/buku" data-valueKey="id" data-displayKey="name" required>	 
</select>
<script>
...
<div class="col-md-12">
	...
	<div class="col-md-12">
		<div id="tablebuku">
			...
			<tr><td class='text-left'> <span id="satuanbukuku"></span></td><td class='text-right' ><button type='submit' name='submit' value='0' class='btn btn-warning btn-sm' style='background-color:<?=$warnabar;?>;color:white;width:120px'><span id="totjualbuku"></span></button></td></tr>
			</table>												
		</form> 
		</div>
		</div>
...
$(document).ready(function(){
	...
	$('#more1').click(function(){
        ...
        {
			$('.isi1').show();
			$("#more1").removeClass("glyphicon glyphicon-chevron-down").addClass("glyphicon glyphicon-chevron-up");	
		}else{
			$('.isi1').hide();
			$("#more1").removeClass("glyphicon glyphicon-chevron-up").addClass("glyphicon glyphicon-chevron-down");	
		}			
	});	
	...
	// $('#more2').click(function(){
        ...
        // {
			// $('.isi2').show();
			// $("#more2").removeClass("glyphicon glyphicon-chevron-down").addClass("glyphicon glyphicon-chevron-up");	
		// }else{
			// $('.isi2').hide();
			// $("#more2").removeClass("glyphicon glyphicon-chevron-up").addClass("glyphicon glyphicon-chevron-down");	
		// }			
	// });		
	$('#more3').click(function(){
        ...
        {
			$('.isi3').show();
			$("#more3").removeClass("glyphicon glyphicon-chevron-down").addClass("glyphicon glyphicon-chevron-up");	
		}else{
			$('.isi3').hide();
			$("#more3").removeClass("glyphicon glyphicon-chevron-up").addClass("glyphicon glyphicon-chevron-down");	
		}			
	});	
...
function hasilbuku(data1,data2,data3,data4,data5,data6,data7,data8){
		var jmlcetak = parseInt(document.getElementById("jmlcetakbu").value);
