...
echo json_encode(array(404 => "error 0"));
}else{
...
<div class="col-md-4" id="ketproduk">
	<div class="row" style="margin-right:5px;margin-left:5px">
		<div class="ket" style="margin:0; padding:5px; line-height: 1.2em;color:#000"><div>Ukuran : 23 x 11 cm<br></div><div>Cetak Amplop 1 warna Ro. 60.000, 2 warna Rp. 75rb, 3 warna Rp 90rb.											</div></div>
	</div>
</div>
<div class="col-md-8">
      <div class="row">
...
<div class="col-md-12">
 ...
 <select name="bahanam" id="bahanam" class="custom-select form-control" data-bahanam="http://kalkulator.go/user/api/katbahan/amplop" data-valueKey="id" data-displayKey="name" required>	 
</select>
				</div>
<script>
...
<div class="col-md-6">	
 ...
 <select name="idmesin" id="idmesin" class="custom-select form-control" data-mesin="http://kalkulator.go/user/api/mesin/amplop" data-valueKey="id" data-displayKey="name" required>	 
</select>
<script>
		...
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			// if( level == 'admin' || level == 'member' ){
				if ($('#tablam').length) {
					...
					$('#tableamp').append("<div id='detailamp' class='small'><table id='tablam' class='table'><thead ><tr style='background-color:#a89726;color:white' ><th  class='text-left' style='width:30%'>Mesin</th><th class='text-right'>Harga</th></tr></thead></table></div>");
					var table = $('#tablam').children();
					var i;
					var no = 1;
					var ongkos_potong = 0;
