...
var cekLebar = document.getElementById("lbrcetakbox3");
...
<div class="modal-header" style="background-color:<?=$warnabar;?>;color:white;">
	...
	<h4 class="modal-title">Cetak Box 3</h4>
</div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
											<div class="input-group">
											  ...
											  <input type="text" class="form-control" aria-label="" id="jmlcetakbox3" value="" autofocus>
										...
										<div class="input-group">
                                            ...
                                            <input type="text" class="form-control input" id="lbrcetakbox3" placeholder="Lebar">
											<span class="input-group-addon">Panjang</span>
                                            <input type="text" class="form-control input" id="pjcetakbox3" placeholder="Panjang">
											<span class="input-group-addon">Tinggi</span>
                                            <input type="text" class="form-control input" id="tgcetakbox3" placeholder="Tinggi" >
                                        </div>
                                        </div>
                                    </div>
										<div class="col-md-7">	
...
<div class="col-md-6">
	...
	<span class="input-group-addon">Jenis</span>
 	<select name="bahanbox3" id="bahanbox3" class="custom-select form-control" data-source="//kalkulator.go/user/api/katbahan/box3/0" data-valueKey="id" data-displayKey="name" required>	 
	</select>
<script>
    ...
    url: $select.attr('data-source'),
      ...
      $select.append($option);
										...
										<div class="form-group">
                                           <div class="input-group">
											  <span class="input-group-addon">Lebar</span>
											  <input type="text" class="form-control" aria-label="" id="lbrpolybox3" value="1">
											  <span class="input-group-addon">Tinggi</span>
											  <input type="text" class="form-control" aria-label="" id="tgpolybox3" value="1">
											</div>
                                        </div>
                                        </div>
<div class="col-md-12">
  ...
  $.ajax({
    url: $select.attr('data-mesin'),
      ...
      $select.append($option);
                                    ...
                                    <div class="col-md-4">		
										<div class="form-group">
											<button  type="submit" class="btn btn-primary btnon" id="cekukuranbox3">Hitung</button>
											<?php echo cNav('box3');?>
