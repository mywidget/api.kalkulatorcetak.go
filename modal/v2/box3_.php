...
echo pilihKertas($arrays,'box3','bahanbox3');
?>
                                        </div>
                                        </div>
                                    </div>
										<div class="col-md-7">	
										<div class="form-group">
										<select id="lambox3" class="selectpicker form-control" data-style="btn-warning">
                                    ...
                                    <div class="col-md-4">		
										<div class="form-group">
											<button  type="submit" class="btn btn-primary btnon" onclick="hitungbox3()">Hitung</button>
											<?php echo cNav('box3');?>
