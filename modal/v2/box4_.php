...
echo pilihKertas($arrays,'box4','bahanbox4');
...
?>
			...
			<div class="col-md-7">	
				<div class="form-group">
				<select id="lambox4" class="selectpicker form-control" data-style="btn-warning">
...
<?php 
echo pilihKertas($arrays,'box4','bahanbawahbox4');
//pilihKertas('array','nama_modul','class_id_modul');
?>
						</div>
					</div>
