...
?>	
			...
			<div class="input-group">
				...
				<select id="j_mesin" class="custom-select selectpicker form-control" data-style="btn-success">
...
<?php 
// echo pilihKertas2($arrayk,10,'buku','bahanbu2');
?>
												</div>
											</div>
											...
											<div class="col-md-7">	
												<div class="form-group">
													...
													<Label class="form-control">Isi Halaman Sama seperti buku tulis</label>
													</div>
												</div>
												</div>											
												<div class="col-md-5">	
												<div class="form-group">
													...
													<Label class="form-control">Pakai Mesin Minioffset</label>
													</div>
												</div>
												</div>
