...
$("#ukuranbu").filter(function() {
       var deptid = 10;
        $.ajax({
            url: '//kalkulator.go/user/api/ukuran/brosur/10',
            type: 'GET',
            dataType: 'json',
 ...
 <select name="bahanbu1" id="bahanbu1" class="custom-select form-control" data-source="//kalkulator.go/user/api/katbahan/buku/0" data-valueKey="id" data-displayKey="name" required>	 
</select>	
												</div>
											</div>
											</div>
 ...
 <select name="j_mesin1" id="j_mesin1" class="custom-select form-control" data-mesin1="//kalkulator.go/user/api/mesin/buku/0" data-valueKey="id" data-displayKey="name" required>	 
</select>
<script>
										...
										<div class="col-md-12">
										  <div class="panel panel-default">
											...
											<div class="form-group">
												<div class="input-group">
												<span class="input-group-addon">Kertas</span>
 <select name="bahanbu2" id="bahanbu2" class="custom-select form-control" data-bahanbu2="//kalkulator.go/user/api/katbahan/buku/0" data-valueKey="id" data-displayKey="name" required>	 
</select>
<script>
...
<div class="form-group">
			<div class="input-group">
				<span class="input-group-addon">Mesin Cetak</span>
 <select name="j_mesin2" id="j_mesin2" class="custom-select form-control" data-mesin2="//kalkulator.go/user/api/mesin/buku/0" data-valueKey="id" data-displayKey="name" required>	 
</select>
<script>
										...
										<div class="col-md-12">
										  <div class="">
											...
											<div class="form-group">
												<div class="input-group">
												<span class="input-group-addon">Kertas</span>
 <select name="bahanbu3" id="bahanbu3" class="custom-select form-control" data-bahanbu3="//kalkulator.go/user/api/katbahan/buku/0" data-valueKey="id" data-displayKey="name" required>	 
</select>
<script>
...
$('select[data-bahanbu3]').each(function() {
  ...
  $.ajax({
	...
	<div class="col-md-12">	
			...
			<div class="input-group">
				<span class="input-group-addon">Mesin Cetak</span>
 <select name="j_mesin3" id="j_mesin3" class="custom-select form-control" data-mesin3="//kalkulator.go/user/api/mesin/buku/0" data-valueKey="id" data-displayKey="name" required>	 
</select>
<script>
...
$('select[data-mesin3]').each(function() {
 ...
 <select name="botbuku" id="botbuku" class="custom-select form-control" data-botbuku="//kalkulator.go/user/api/katbahan/bot/0" data-valueKey="id" data-displayKey="name" required>	 
</select>
<script>
    ...
    url: $select.attr('data-botbuku'),
      ...
      $select.append($option);
											...
											<div class="form-group">
												<div class="input-group">
												<span class="input-group-addon">Kertas</span>
 <select name="bahancovbu" id="bahancovbu" class="custom-select form-control" data-bahancovbu="//kalkulator.go/user/api/katbahan/buku/0" data-valueKey="id" data-displayKey="name" required>	 
</select>
<script>
...
$('select[data-bahancovbu]').each(function() {
  ...
  $.ajax({
	...
	<div class="col-md-12">	
			...
			<div class="input-group">
				<span class="input-group-addon">Mesin Cetak</span>
 <select name="j_mesinc" id="j_mesinc" class="custom-select form-control" data-mesinc="//kalkulator.go/user/api/mesin/buku/0" data-valueKey="id" data-displayKey="name" required>	 
</select>
<script>
