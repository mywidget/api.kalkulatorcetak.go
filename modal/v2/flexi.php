...
<div class="col-md-6">
<div style="margin:0; padding:15px;line-height: 1.2em;background-color:#EC1B4B;">
<span class="more">
<?=$row['keterangan'];?>
</span>
</div>
...
<div class="col-md-6" >
									...
									<div class="form-group">
										...
										<?php $sql_bhn = mysql_query("SELECT * FROM kategori_bahan where modul like '%flexi%' AND pub='Y' ORDER BY id_kategori"); ?>
