...
<div class="col-md-12"><div class="alert"></div></div>
										<div class="col-md-7">	
											...
											<div class="form-group">		
												<div class="input-group">
												<?php $sql_bhn = mysql_query("SELECT * FROM kategori_bahan where modul like '%top%' AND pub='Y' ORDER BY id_kategori"); 
												$row=mysql_fetch_array($sql_bhn)
												?>
											...
											<div class="form-group">		
												<div class="input-group">
												<?php $sql_bhn = mysql_query("SELECT * FROM kategori_bahan where modul like '%middle%' AND pub='Y' ORDER BY id_kategori"); 
												$row=mysql_fetch_array($sql_bhn)
												?>
											...
											<div class="form-group">		
												<div class="input-group">
												<?php $sql_bhn = mysql_query("SELECT * FROM kategori_bahan where modul like '%bottom%' AND pub='Y' ORDER BY id_kategori"); 
												$row=mysql_fetch_array($sql_bhn)
												?>
...
function hitungnot() {
		...
		if(percentComplete){setTimeout(function(){$(".progress-bar").css('background','green');$('#tablenot').show();}, 500);}}},false);
