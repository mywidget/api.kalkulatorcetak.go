...
<div class="form-row">
            <div class="form-group col-md-12">
               <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="tgcetakam" onchange="cekukuranam()">
               </div>
            </div>
</div>
<div class="form-row">
...
<div class="custom-control custom-checkbox mb-3">
          ...
          <div class="form-row">
            <div class="form-group col-md-12">
               <div class="input-group">
                  <span class="input-group-text">Lebar</span>
                  <input type="text" class="form-control" id="lbrpolyam" value="1" readonly>
                  <span class="input-group-text">Tinggi</span>
                  <input type="text" class="form-control" id="tgpolyam" value="1" readonly>
               </div>
            </div>
         </div>
