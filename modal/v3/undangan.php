...
<div class="modal-header" style="background-color:<?=$warnabar;?>;color:white;">
	<h4 class="modal-title text-white">Cetak Undangan</h4>
...
<div class="modal-body p-2">
   ...
   <div class="card-header p-0 ">
				<h6 class="mb-0 ml-2 p-0"><a data-toggle="collapse" href="#" id="moreisiund" class="ni ni-bold-down text-warning"> Isi undangan</a></h6>
			</div>
        <div class="form-row">
               <div class="form-group col-md-12">
                  <div class="input-group">
...
<div class="form-row">
		 ...
		 <div class="card p-0">
			<div class="card-header p-0 ">
				<h6 class="mb-0 ml-2 p-0"><a data-toggle="collapse" href="#" id="morecovund" class="ni ni-bold-down text-warning"> Cover undangan </a></h6>
			</div>
   ...
   <div class="form-row ucapanund">
					...
					<div class="form-group col-md-4">
						<div class="input-group">
							...
							<select name="bahankartuucapan" id="bahankartuucapan" class="custom-select form-control" data-bahankartu="<?= $host; ?>/api/<?= $app_id; ?>/katbahan/<?= $mod; ?>/0" data-valueKey="id" data-displayKey="name" required>
							</select>
						</div>
					</div>
					<div class="form-group col-md-4">
            ...
            <div id='tablund' class='small'>
               <table id='tablund' class='table table-striped' >
                  ...
                  <tr>
                     ...
                     <td class='text-right' ><button type='submit' name='submit' value='0' class='btn btn-warning btn-sm' style='background-color:<?=$warnabar;?>;color:white;width:120px'><span id="totjualund"></span></button></td>
                  </tr>
               </table>
            </div>
         </form>
