	...
	<div class="modal-body p-2">
		...
		<div class="card p-0 mb-0">
			<div class="card-header p-0 ">
				<h6 class="mb-0 ml-2 p-0"><a data-toggle="collapse" href="#" id="more" class="ni ni-bold-right text-warning"> Isi agenda 1 </a></h6>
			</div>
			<div class="card-body collapse show p-0">
				<div class="card-block isi1 <?=$rowx;?> pt-1 pb-1">
					<div class="form-row">
		...
		<div class="card p-0 mb-0">
			...
			<div class="card-body p-0 isi2">
				<div class="card-block <?=$rowx;?> pt-1 pb-1">
					<div class="form-row">
						<div class="form-group col-md-4">
							<div class="input-group">
								<div class="input-group-prepend">
		...
		<div class="card p-0 mb-0">
			<div class="card-header p-0">
				<h6 class="mb-0 ml-2 p-0"><a data-toggle="collapse" href="#" id="more4" class="ni ni-bold-down text-warning"> Klik untuk detail finishing Cover</a></h6>
			</div>
