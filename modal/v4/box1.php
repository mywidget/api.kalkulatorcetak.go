<?php
	if (!empty($_POST['link'])) {
	?>
	<div class="modal-header" style="background-color:<?= $warna; ?>;color:#fff;">
	...
	<div class="modal-body p-2">
		...
		<div class="form-row">
			<div class="form-group col-md-12 jml">
				<div class="input-group">
					...
					<input type="text" class="form-control" value="500" id="jmlcetakbox1">
					<div class="input-group-append">
		...
		<div class="form-row">
			...
			<div class="form-group col-md-4 tgcetakbox1">
				<div class="input-group">
		...
		<div class="form-row">
			...
			<div class="form-group col-md-5 lbr">
				<div class="input-group">
		...
		<div class="form-row">
			...
			<div class="form-group col-md-6 idmesin<?= $mod; ?>">
				<div class="input-group">
