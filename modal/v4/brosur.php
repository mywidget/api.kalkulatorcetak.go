		...
		<div class="form-row">
			<div class="form-group col-md-6">
				<div class="input-group mb-1">
					...
					<select name="jmlcetaks" id="jmlcetaks" class="custom-select form-control">
					...
					<input type="text" class="form-control" id="jmlcetak" placeholder="0" value="">
			...
			<div class="form-group col-md-6">
				<div class="input-group">
					...
					<select name="ukuran" id="ukuran" class="custom-select form-control ukuran" required>
