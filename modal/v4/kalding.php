<?php
	...
	<div class="modal-body p-2">
		...
		<div class="form-row">
			...
			<div class="form-group col-md-6 has-danger bahanp">
				<div class="input-group">
					...
					<select name="bahank" id="bahank" class="custom-select form-control" data-source="<?=$host;?>/api/<?=$app_id;?>/katbahan/<?=$mod;?>/0" data-valueKey="id" data-displayKey="name" required>
					</select>
				</div>
			</div>
		...
		<div class="form-row">
			<div class="form-group col-md-12 idkertas">
				<div class="input-group">
		...
		<div class="form-row mb-1">
			...
			<div class="form-group col-md-6 bahancovkal">
				<div class="input-group">
					<span class="input-group-text ">Uk.plano</span>
					<select id="idkertask" name="idkertask" class="custom-select form-control">
						<option value="0">- Pilih ukuran -</option>
					</select>
				</div>
			</div>
					...
					<div id='tablkk' class='small'>
						<table id='tablkk' class='table table-striped'>
							...
							<tr>
								...
								<td class='text-right'><button type='submit' name='submit' value='0' class='btn btn-warning btn-sm btn-sm hint--top-left' aria-label='Detail hitung' style='background-color:<?= $warnabar; ?>;color:white;width:120px'><span id="totjual"></span></button></td>
							</tr>
						</table>
