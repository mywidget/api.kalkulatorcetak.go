<?php
	if (!empty($_POST['link']) AND $_SERVER['HTTP_REFERER']==$_POST['link']) {
		$warnabar = "#07470f";
	?>
	<script>
	...
	<div class="modal-body">
						...
						<div id="hasilhota">
							<form action="detail-hitung/" method="post" target="_blank">
								...
								<table id='tablenota' class='table table-striped table-responsive'>
									...
									<tr>
										<td class='text-left'>Harga Satuan <span id="satuanota"></span></td>
										<td class='text-right'><button type='submit' name='submit' value='0' class='btn btn-warning btn-sm' style='background-color:<?= $warnabar; ?>;color:white;width:120px' onclick="this.form.submit()"><span id="totjualnota"></span></button></td>
									</tr>
								</table>
							</form>
						</div>
		...
		<script>
			...
			function hitungnot() {
				...
				var jmlset = 1;
				var lbrf1 = 1;
				var tgf1 = 1 / 500; //1 rim jadi 10 buku		
				var lbrf2 = 1;
				var tgf2 = 1;
				var lbrf3 = 1;
				var tgf3 = 1;
