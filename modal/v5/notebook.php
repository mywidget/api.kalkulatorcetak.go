	...
	<div class="modal-body p-2">
		...
		<div class="card p-0 mb-0">
			<div class="card-header p-0">
				<h6 class="mb-0 ml-2 p-0"><a data-toggle="collapse" href="#" id="more1" class="ni ni-bold-down text-warning"> Isi Notebook</a></h6>
			</div>
		...
		<div class="card p-0 mb-0">
			<div class="card-header p-0">
				<h6 class="mb-0 ml-2 p-0"><a data-toggle="collapse" href="#" id="more4" class="ni ni-bold-down text-warning"> Cover </a></h6>
			</div>
